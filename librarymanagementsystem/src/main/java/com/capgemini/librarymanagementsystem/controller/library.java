						...
						try {
							...
							try {
								...
								case 2:
									...
									System.out.println("enter category");
									@SuppressWarnings("unused") String category = sc.next();
									Book bean2 = new Book();
									bean2.setBookId(bid);
								...
								case 9:
									try {
										...
										System.out.println(String.format("%-15s %-10s %-10s %-15s %s", "UserId","UserName","UserEmail","UserNoOfBooksBorrowed"));
										...
										System.out.println("none of the users are registered in the library");
									}
									break;
								case 10:
									try {
										...
										System.out.println(String.format("%-15s %-10s %-10s %-15s %s", "BookId","BookName","UserId","UserName","BookIssued","BookReturned"));
